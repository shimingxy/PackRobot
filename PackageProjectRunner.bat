...
SET JAVA_OPTS=%JAVA_OPTS% -Xmx1024m -Djava.library.path=./javahl.win32/
...
SET JAR_EXEC=%JAVA_HOME%/bin/jar
...
%JAVA_EXEC% %JAVA_OPTS%  -classpath %JAVA_CLASSPATH% %JAVA_MAINCLASS%  --config packproject.xml
